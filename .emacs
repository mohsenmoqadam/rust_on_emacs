...
(custom-set-variables
 ...
 '(package-selected-packages
   '(breadcrumb treemacs exec-path-from-shell toml-mode rust-playground lsp-ui yasnippet use-package rustic lsp-mode flycheck company))
  ...
  (progn
    (setq treemacs-collapse-dirs                   (if treemacs-python-executable 3 0)
	  ...
	  treemacs-indentation-string              " "
          ...
          treemacs-project-follow-cleanup          'all
